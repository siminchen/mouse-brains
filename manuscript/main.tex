...
\begin{flushleft}
{\Large
\textbf{Determining Neuroglial Cell Subtypes from RNA-Seq Transcriptome Expression Data}
}
% Insert Author names, affiliations and corresponding author email.
\\
Simin Chen$^{1}$, 
Nicholas Turner$^{2\ast}$, 
\\
\bf{1}  Department of Computer Science, Princeton University, Princeton, NJ, USA
\\
\bf{2}  Department of Computer Science, Princeton University, Princeton, NJ, USA
\\

$\ast$ E-mail: Corresponding author@cs.princeton.edu
\end{flushleft}
...
\subsection*{RNA-seq "transcriptome" database~\cite{Zhang_2014}}
We gathered an RNA-seq "transcriptome" database from a repository within the Gene Expression Omnibus, which was generated under "RNA-Seq transcriptome and splicing database of neurons, glia, and vascular cells of the cerebral cortex." Each file (in RSA format) consists of a sample of the RNA transcripts for a highly purified sample of constituent cell groups for over 22,000 genes.
% Results and Discussion can be combined.
\section*{Results}
\subsection*{Produce a methodology of more transparent access to the dataset}
\subsection*{Methods development towards discovering clusters in transcriptome datasets}
\subsection*{Identify subtypes of glia}
